...
/**
 * Atributos devolvidos pela resposta de gerenciamento de Motor
 * @param id Identificador único de motor
 * @param setorId Identificador único de setor
 * @param setorNome nome do setor
 * @param codigoAtivo código do ativo do motor
...
public record MotorResponseDTO(
        ...
        @Schema(
                description = "Identificador único do ID",
                example = "1"
        )
        @NotNull
        Integer id,
        ...
        @Size(max = 100, message = "O nome setor deve ter até 100 caracteres")
        String setorNome,
